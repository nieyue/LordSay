...
public class BannerController {
	...
	@ApiImplicitParams({
	  @ApiImplicitParam(name="type",value="类型，默认1首页轮播，2视频，3文章",dataType="int", paramType = "query"),
	...
	public @ResponseBody StateResultList browsePagingBanner(
	...
	@ApiImplicitParams({
		  @ApiImplicitParam(name="bannerId",value="bannerID",dataType="int", paramType = "path",required=true)
		  })
	@RequestMapping(value = "/{bannerId}", method = {RequestMethod.GET,RequestMethod.POST})
	public  StateResultList loadBanner(@PathVariable("bannerId") Integer bannerId,HttpSession session)  {
		List<Banner> list = new ArrayList<Banner>();
